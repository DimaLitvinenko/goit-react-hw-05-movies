export default function infiniteScroll(arr, timeOut, threshold, callFoo) {
   ...
   let lastId = arr[arr.length - 1].id; //запоминаем id крайнего на даный момент элемента галереи
   setTimeout(() => {
      ...
      let observer = new IntersectionObserver(
         ...
         { threshold: threshold },
      ); // подгрузка следующих элементов сработает при появлении threshold% цели в области видимости окна
